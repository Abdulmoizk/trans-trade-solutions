...
const WhatsAppButton = () => {
  // WhatsApp link format: https://wa.me/[country code][phone number without + or spaces]
  // Phone: +92 329 2574256 → 923292574256
  const whatsappLink = "https://wa.me/923292574256";
