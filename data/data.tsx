  ...
  const specialFeaturesData = [
    {
      ...
      img: <Globe size={64} strokeWidth={0.5} className="text-[#1850A0]" />,
    ...
    },
    {
      ...
      img: <Cpu size={64} strokeWidth={0.5} className="text-[#1850A0]" />,
    ...
    },
    {
      ...
      img: <Leaf size={64} strokeWidth={0.5} className="text-[#1850A0]" />,
    ...
    },
    {
      ...
      img: <Shield size={64} strokeWidth={0.5} className="text-[#1850A0]" />,
    ...
    },
    {
      ...
      img: <Headset size={64} strokeWidth={0.5} className="text-[#1850A0]" />,
